...
from ..services.dynasty_comparison import dynasty_comparison_service
import json
from pathlib import Path

router = APIRouter(prefix="/api/dynasty", tags=["Dynasty Comparison"])
...
@router.post("/cross-era", response_model=CrossEraComparisonResponse)
async def compare_cross_era(request: CrossEraComparisonRequest):
    try:
        result = dynasty_comparison_service.compare_cross_era(
